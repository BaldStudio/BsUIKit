...
public struct Material {
     ...
     public struct Red {
        ...
        public static let P50  = UIColor(0xFFEBEE)
        public static let P100 = UIColor(0xFFCDD2)
        public static let P200 = UIColor(0xEF9A9A)
        public static let P300 = UIColor(0xE57373)
        public static let P400 = UIColor(0xEF5350)
        public static let P500 = UIColor(0xF44336)
        public static let P600 = UIColor(0xE53935)
        public static let P700 = UIColor(0xD32F2F)
        public static let P800 = UIColor(0xC62828)
        public static let P900 = UIColor(0xB71C1C)
        public static let A100 = UIColor(0xFF8A80)
        public static let A200 = UIColor(0xFF5252)
        public static let A400 = UIColor(0xFF1744)
        public static let A700 = UIColor(0xD50000)
        
    }
     
     public struct Pink {
         public static let P50  = UIColor(0xFCE4EC)
         public static let P100 = UIColor(0xF8BBD0)
         public static let P200 = UIColor(0xF48FB1)
         public static let P300 = UIColor(0xF06292)
         public static let P400 = UIColor(0xEC407A)
         public static let P500 = UIColor(0xE91E63)
         public static let P600 = UIColor(0xD81B60)
         public static let P700 = UIColor(0xC2185B)
         public static let P800 = UIColor(0xAD1457)
         public static let P900 = UIColor(0x880E4F)
         public static let A100 = UIColor(0xFF80AB)
         public static let A200 = UIColor(0xFF4081)
         public static let A400 = UIColor(0xF50057)
         public static let A700 = UIColor(0xC51162)
     }

     public struct Purple {
         public static let P50  = UIColor(0xF3E5F5)
     ...
     public struct DeepPurple {
         public static let P50  = UIColor(0xEDE7F6)
     ...
     public struct Indigo {
         public static let P50  = UIColor(0xE8EAF6)
     ...
     public struct Blue {
         public static let P50  = UIColor(0xE3F2FD)
     ...
     public struct LightBlue {
         public static let P50  = UIColor(0xE1F5FE)
         public static let P100 = UIColor(0xB3E5FC)
         public static let P200 = UIColor(0x81D4FA)
         public static let P300 = UIColor(0x4FC3F7)
         public static let P400 = UIColor(0x29B6F6)
         public static let P500 = UIColor(0x03A9F4)
         public static let P600 = UIColor(0x039BE5)
         public static let P700 = UIColor(0x0288D1)
         public static let P800 = UIColor(0x0277BD)
         public static let P900 = UIColor(0x01579B)
         public static let A100 = UIColor(0x80D8FF)
         public static let A200 = UIColor(0x40C4FF)
         public static let A400 = UIColor(0x00B0FF)
         public static let A700 = UIColor(0x0091EA)
     }

     public struct Cyan {
         public static let P50  = UIColor(0xE0F7FA)
     ...
     public struct Teal {
         public static let P50  = UIColor(0xE0F2F1)
     ...
     public struct Green {
         public static let P50  = UIColor(0xE8F5E9)
     ...
     public struct LightGreen {
         public static let P50  = UIColor(0xF1F8E9)
     ...
     public struct Lime {
         public static let P50  = UIColor(0xF9FBE7)
     ...
     public struct Yellow {
         public static let P50  = UIColor(0xFFFDE7)
     ...
     public struct Amber {
         public static let P50  = UIColor(0xFFF8E1)
     ...
     public struct Orange {
         public static let P50  = UIColor(0xFFF3E0)
     ...
     public struct DeepOrange {
         public static let P50  = UIColor(0xFBE9E7)
     ...
     public struct Brown {
         public static let P50  = UIColor(0xEFEBE9)
     ...
     public struct Grey {
         public static let P50  = UIColor(0xFAFAFA)
     ...
     public struct BlueGrey {
         public static let P50  = UIColor(0xECEFF1)
